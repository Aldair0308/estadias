...
<head>
    ...
    <title>Comparar Versiones de Plantilla</title>
    ...
    <div class="container-fluid py-5">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                ...
                <h5 class="text-muted">{{ $version1->original_name }}</h5>
            </div>
            <div>
                <a href="{{ route('templates.history', $version1->parent_id ?? $version1->id) }}" class="btn btn-secondary">Volver al Historial</a>
                <a href="{{ route('templates.show', $version1->parent_id ?? $version1->id) }}" class="btn btn-outline-secondary">Ver Plantilla</a>
            </div>
        </div>
