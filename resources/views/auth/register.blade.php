...
<head>
    ...
    <title>Registro - UTVstay</title>
    @vite(['resources/js/theme.js', 'resources/css/app.css', 'resources/js/passwordVisibility.js'])
...
<body class="bg-pattern bg-cover bg-center bg-fixed min-h-screen flex flex-col justify-center items-center px-4 py-2 text-white">
    ...
    <div class="w-full max-w-md mx-auto relative">
        <div class="glass rounded-3xl overflow-hidden p-8 md:p-10 transform transition-all duration-500 hover:shadow-2xl">
            ...
            <div class="text-center mb-8">
                <h2 class="text-xl font-medium text-white mb-1">{{ __('Crear cuenta') }}</h2>
                <p class="text-green-200 text-sm opacity-90">{{ __('Únete a nuestra comunidad') }}</p>
            </div>
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-6">
                ...
                <div>
                    <label for="name" class="block text-sm font-medium text-green-100 mb-1 ml-1">{{ __('Nombre') }}</label>
                    <div class="relative">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input
                            ...
                            class="pl-10 pr-10 py-3 w-full rounded-xl bg-white/10 border border-white/20 text-white placeholder-gray-300 focus-ring"
                            placeholder="••••••••" />
                ...
                <div>
                    <label for="password_confirmation" class="block text-sm font-medium text-green-100 mb-1 ml-1">{{ __('Confirmar contraseña') }}</label>
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <input
                            ...
                            class="pl-10 pr-10 py-3 w-full rounded-xl bg-white/10 border border-white/20 text-white placeholder-gray-300 focus-ring"
                            placeholder="••••••••" />
                        <div class="absolute inset-y-0 right-0 pr-3 flex items-center cursor-pointer" onclick="togglePasswordVisibility('password_confirmation')">                            <svg id="show-password-confirmation-icon" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" style="display: block;">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                            </svg>

                            <svg id="hide-password-confirmation-icon" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" style="display: none;">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88l-3.29-3.29m7.532 7.532l3.29 3.29M3 3l3.59 3.59m0 0A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.543 7a10.025 10.025 0 01-4.132 5.411m0 0L21 21" />
                            </svg>
                        </div>
                    </div>
